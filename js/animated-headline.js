jQuery(document).ready(function($){
	//set animation timing I gotta change this time
	var animationDelay = 5000,
		//loading bar effect, btw its to long and lazy to wating
		barAnimationDelay = 3800,
		barWaiting = barAnimationDelay - 3000, //3000 is the duration of the transition on the loading bar - set in the scss/css file
		//letters effect, what kinda number lol
		lettersDelay = 50,
		//type effect unn I gotta learn JQuery
		typeLettersDelay = 150,
		selectionDuration = 500,
		typeAnimationDelay = selectionDuration + 800,
		//clip effect, ummm I don't know too hah
		revealDuration = 600,
	...
	function animateHeadline($headlines) {
		...
		$headlines.each(function(){
			...
			//trigger animation, where is trriger and I have to say 
	...
	function showWord($word, $duration) {
		//didn't know showWord, I gotta search something about this
		if($word.parents('.box-headline').hasClass('type')) {
